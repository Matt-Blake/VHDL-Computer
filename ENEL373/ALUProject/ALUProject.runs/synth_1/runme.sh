...
HD_PWD='C:/Courses/ENEL373/projects/ALUProject/ALUProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Project_File.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Project_File.tcl
