...
set rc [catch {
  ...
  open_checkpoint Project_File_routed.dcp
  set_property webtalk.parent_dir P:/Courses/Lab_A03_group_10/ENEL373/ALUProject/ALUProject.cache/wt [current_project]
